	...
	return apply_filters(
		'aromatic_get_testimonial_default', json_encode(
				...
				array(
					...
					'text'            => esc_html__( 'nitinLorem ipsum, dolor sit amet consectetur adipisicing elit. Amet, accusamus? Id eveniet reprehenderit aliquam, in error iure odit obcaecati aspernatur consequuntur corrupti eos doloribus? Ipsam neque nihil aliquam ut  voluptas.', 'ecommerce-companion' ),
	...
	return apply_filters(
		'aromatic_get_testimonial3_default', json_encode(
				...
				array(
					...
					'text'            => esc_html__( 'nitinLorem ipsum, dolor sit amet consectetur adipisicing elit. Amet, accusamus? Id eveniet reprehenderit aliquam, in error iure odit obcaecati aspernatur consequuntur corrupti eos doloribus? Ipsam neque nihil aliquam ut  voluptas.', 'aromatic-pro' ),
