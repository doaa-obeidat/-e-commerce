...
<?php if( (isset($_GET['tab']) && $_GET['tab'] == 'ux') && (isset($_GET['subtab']) && $_GET['subtab'] == 'advanced')) { ?>
        <?php
          $_disable 			= true;
          $_available_in_pro 	= ' - <span style="color:red;font-size:14px;">'. esc_html__("Available in premium version","pie-register") . '</span>';
			  ?>
        <h3><?php echo esc_html(__("Pie Register Theme",'pie-register')) . wp_kses_post($_available_in_pro) ?></h3>
        <div class="fields">
