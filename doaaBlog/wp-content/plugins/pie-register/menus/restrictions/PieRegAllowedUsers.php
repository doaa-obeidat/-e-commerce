        ...
        <div id="tabsSetting" class="tabsSetting">
          <ul class="tabLayer1">
            <li><a href="#piereg_block_by_username">
              <?php esc_html_e("Allowed Users by Username","pie-register") ?>
              </a></li>
            <li><a href="#piereg_block_by_email">
              <?php esc_html_e("Allowed Users by Email Address","pie-register") ?>
              </a></li>
          </ul>
        </div>
      </div>
              ...
              <form method="post" action="#piereg_block_by_username">
                ...
                <div class="fields">
                  ...
                  <label for="enable_allowedusername">
                    <?php esc_html_e("Only allow users listed below to login or register to my site.","pie-register"); ?>
                  </label>
                </div>
                <div class="fields">
                  <h3>
              ...
              <form method="post" action="#piereg_block_by_email">
                ...
                <div class="fields">
                  ...
                  <label for="enable_allowedemail">
                    <?php esc_html_e("Only allow users using email address listed below to login or register to my site.","pie-register"); ?>
                  </label>
                </div>
                <div class="fields">
                  <h3>
