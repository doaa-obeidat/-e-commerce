        ...
        <div class="tabOverwrite">
            <div id="tabsSetting" class="tabsSetting">            
                <ul class="tabLayer1">
                    ...
                    <li><a href="#piereg_paypal_payment_gateway"><?php esc_html_e("PayPal Standard","pie-register") ?></a></li><!--Add Paypal-->
          ...
          <div class="right_section">
            <div class="settings">
              ...
              <div id="pie-register">
                ...
                <li><?php esc_html_e("Go to Merchant Services and Click on","pie-register"); ?> <a target="_blank" href="https://www.paypal.com/ae/cgi-bin/webscr?cmd=_web-tools"><?php esc_html_e("Buy Now","pie-register"); ?></a> <?php esc_html_e("button","pie-register"); ?>.</li>
