...
<div id="container"  class="pieregister-admin">
    <div class="right_section pro-page">
        ...
        <ul class="go-pro-tabs">
            <li class="<?php echo ($action != "addons") ? esc_attr($active) :""; ?>"><a href="admin.php?page=pie-pro-features"><?php esc_html_e("Features","pie-register") ?></a></li>
            <?php if( $this->no_addon_activated ){
                ?>
                <li class="<?php echo ($action == "addons") ? esc_attr($active) :""; ?>"><a href="admin.php?page=pie-pro-features&tab=addons"><?php esc_html_e("Addons","pie-register") ?></a></li>
                <?php
            }
            ?>
        </ul>
