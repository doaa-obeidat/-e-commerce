  ...
  <div class="settings" style="padding-bottom:0px;">
    <div class="right_section importexport">
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php esc_html_e("All Settings",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <div class="fields">
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php esc_html_e("E-mail Templates",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php esc_html_e("Invitation Codes",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php esc_html_e("All User Data with Custom Fields",'pie-register') ?> <?php echo wp_kses_post($_available_in_pro); ?>
        </legend>
        <?php
            ...
            <li>
              <div class="fields date">
                ...
                <div class="start_date">
                  ...
                  <img id="start_icon" src="<?php echo esc_url(PIEREG_PLUGIN_URL.'assets/images/calendar_img.jpg') ?>" width="22" height="22" alt="calendar" class="calendar_img" /> </div>
                <div class="end_date">
                  <label for="field_">
                    <?php esc_html_e("End","pie-register"); ?>
                  </label>
                  <input readonly id="date_end" name="date_end" type="text" class="input_fields date_start" />
                  <img id="end_icon" src="<?php echo esc_url(PIEREG_PLUGIN_URL.'assets/images/calendar.png') ?>" width="22" height="22" alt="calendar" class="calendar_img" /> </div>
