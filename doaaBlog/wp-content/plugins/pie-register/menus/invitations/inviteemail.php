...
?>
<fieldset class="piereg_fieldset_area-nobg" <?php disabled($_disable, true); ?>>
    ...
    <div class="cols-3">          
      <select required id="pie_email_linkpage" name="pie_email_linkpage" >
        ...
        foreach( $pages as $page ) : $page->post_content; ?>
          <option value="<?php echo esc_attr($page->ID); ?>" <?php selected($piereg['pie_email_linkpage'] == $page->ID, true); ?>>
...
<li class="clearfix">
  <div class="fields">
    <div  class="cols-2">
      <h3>
        <?php esc_html_e("Select Invitation Code *","pie-register");?>
      </h3>
    </div><!-- cols-3 -->
    <div class="cols-3">          
...
<li class="clearfix">
  <div class="fields">
    <div class="cols-2">
      <h3>
        <?php esc_html_e("Invite users to register (invite manually or through import): ","pie-register");?>
      </h3>
    </div>
    <div class="cols-3">
...
<li class="clearfix">
  <div class="fields extra-margin">
    <div class="cols-3">
      ...
      <span class="quotation import-email-invites">
        <strong><?php esc_html_e("Warning","pie-register"); ?></strong>:
        <?php esc_html_e("Supports CSV format.","pie-register"); ?>
      </span>             
      <span class="quotation import-email-invites"><?php echo sprintf( __( 'You may want to see', 'pie-register').' <a target="_blank" download href="%s"> '.esc_html__('this example of the CSV file.', 'pie-register').'</a>. Use a separate line for each email address.' , esc_url(plugin_dir_url(__FILE__).'../examples/example-import-email-addresses-test.csv')); ?>
      </span>
    </div>
  </div>
</li>
<li class="clearfix">
  <div class="fields fields_submitbtn">
    ...
    <div class="cols-3 text-right">
      <input name="send_invite_email" class="submit_btn btn-send-invite" value="<?php esc_attr_e('Send Invitation','pie-register');?>" type="submit" />
    </div><!-- cols-3 -->
  </div>
</li>
<li class="notice-invite-status">
  <div class="fields "><div class="cols-2">&nbsp;</div><!-- cols-3 -->
    <div class="cols-3 text-right"><i><?php echo esc_html_e('Enable the invitation code feature to send invitations.','pie-register') ?>.</i></div><!-- cols-3 -->
  </div>
</li>
</ul>
</form>
...
<form method="post" action="">
  <?php if( function_exists( 'wp_nonce_field' )) wp_nonce_field( 'piereg_wp_invitation_code_nonce','piereg_invitation_code_nonce'); ?>
  <h3><?php echo esc_html_e('Customize Email Template','pie-register'); ?></h3>
  <ul class="bg-white clearfix invite-form custom-template">
       ...
       <li class="clearfix">
        <div class="fields">
          <div  class="cols-2">
            <h3>
              <?php esc_html_e("From","pie-register");?>
            </h3>
          </div><!-- cols-3 -->
         <div class="cols-3">          
      ...
      <li class="clearfix">
        <div class="fields">
          <div  class="cols-2">
            <h3>
              <?php esc_html_e("From Email","pie-register");?>
            </h3>
          </div><!-- cols-3 -->
         <div class="cols-3">          
      ...
      <li class="clearfix">
        <div class="fields">
          <div  class="cols-2">
            <h3>
              <?php esc_html_e("Subject","pie-register");?>
            </h3>
          </div><!-- cols-3 -->
         <div class="cols-3">
      ...
      <li class="clearfix">
        <div class="fields">
          <div  class="cols-2">
            <h3>
              <?php esc_html_e("Email Body","pie-register");?>
            </h3>
          </div><!-- cols-3 -->
         <div class="cols-3">          
          ...
          <b onclick="selectText('piereg-select-all-text-onclick_invite_link')" id="piereg-select-all-text-onclick_invite_link">%invitation_link%</b> <?php echo esc_html_e('Invitation link replacement key can be used in Email Body','pie-register'); ?>
          <br />
          <b onclick="selectText('piereg-select-all-text-onclick_blogname')" id="piereg-select-all-text-onclick_blogname">%blogname%</b> <?php echo esc_html_e('Site Title replacement key can be used in Email Body and Subject','pie-register'); ?>
          </div><!-- cols-3 -->         
        </div>
      </li>
      <li class="clearfix">
        <div class="fields fields_submitbtn">
          <div class="cols-2">&nbsp;</div><!-- cols-3 -->
          <div class="cols-3 text-right">
            <input name="submit_invite_email" class="submit_btn" value="<?php esc_attr_e('Save','pie-register');?>" type="submit" />
          </div><!-- cols-3 -->
        </div>
      </li>
  </ul>
