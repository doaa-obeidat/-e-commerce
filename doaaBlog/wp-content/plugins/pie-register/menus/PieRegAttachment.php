        ...
        <div class="" style="padding-bottom:0px;">
            <div class="attachment settings">            
                <h2 class="headingwidth">
                    <?php esc_html_e("Download Attachments",'pie-register'); ?> <?php echo wp_kses_post($_available_in_pro); ?>
                </h2>
                    <div class="pieHelpTicket">                    
                            ...
                            <div style="float:left;border-right:#ccc 1px solid;margin-right:5px;">
                                ...
                                <input disabled type="submit" value="<?php esc_attr__("Apply","pie-register"); ?>" class="button action" id="doaction" name="btn_submit_attachment_bulk_option">
                                </form>
