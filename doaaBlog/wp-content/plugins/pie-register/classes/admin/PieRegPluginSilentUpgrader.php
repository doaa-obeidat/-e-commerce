 ...
 *
 * @internal Please do not use this class outside of core Pie Register development. May be removed at any time.
 *
 */
class PieRegPluginSilentUpgrader extends Plugin_Upgrader {
	...
	public function install( $package, $args = array() ) {
		...
		if ( true === $result ) {
			do_action( 'pieregister_plugin_installed', $package );
		}
