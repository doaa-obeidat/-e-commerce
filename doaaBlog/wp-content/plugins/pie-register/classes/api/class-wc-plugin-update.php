 ...
 *
 *		new WC_API_Manager_Plugin_Update_API_Check( $upgrade_url, $plugin_name, $product_id, $api_key, $activation_email, $renew_license_url, $instance, $domain, $plugin_or_theme, $this->piereg_text_domain );
 *	}
 */
