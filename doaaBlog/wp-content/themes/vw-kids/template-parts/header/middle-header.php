...
<div id="menu-box">
  <div class="header-menu <?php if( get_theme_mod( 'vw_kids_sticky_header', false) != '' || get_theme_mod( 'vw_kids_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
    <div class="container">
