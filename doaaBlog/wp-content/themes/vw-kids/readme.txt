...
= 0.4.2 =
* Resolved the woocommerce product search error.
...
= 0.6 =
* Resolved admin bar mobile menu close button & sticky header error.
...
= 0.6.9 =
* Resolved function error in ctypo file.
...
= 0.8.5 =
* Changes done in theme style.
* Done changes in custom-home-page.php file.

= 0.8.6 =
* Added ibtana page template file.

= 0.8.7 =
* Removed default global color.
