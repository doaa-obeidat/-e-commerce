...
function vw_kids_logo_customize_register( $wp_customize ) {
  ...
  $wp_customize->add_setting('vw_kids_site_title_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_kids_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','vw-kids'),
      ...
      'placeholder' => __( '10px', 'vw-kids' ),
		...
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'vw_kids_logo_title_hide_show'
	));
  ...
  $wp_customize->add_setting('vw_kids_site_tagline_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_kids_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','vw-kids'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-kids'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'vw-kids' ),
    ),
    'priority'    => 12,
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'vw_kids_tagline_hide_show'
	));
}
