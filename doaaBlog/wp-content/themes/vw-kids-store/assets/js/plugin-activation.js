jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_kids_store_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-kids-store-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-kids-store-plugin-install');
                button.addClass('button-primary vw-kids-store-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-kids-store-recommended-plugins .vw-kids-store-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-kids-store-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-kids-store-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-kids-store-recommended-plugins').css('display','none');
    });
