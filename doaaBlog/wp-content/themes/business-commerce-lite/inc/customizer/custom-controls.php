<?php
/**
 * Business Commerce Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 *
	 */
	class Business_Commerce_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business-commerce-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="business_commerce_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	class Business_Commerce_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_commerce_simple_notice';
	 ...
	 */
	class Business_Commerce_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_commerce_toggle_switch';
	 ...
	 */
	class Business_Commerce_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_commerce_dropdown_select2';
	 ...
	 */
	class Business_Commerce_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_commerce_dropdown_posts';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			// Get our Posts
			$this->posts = Business_Commerce_Customizer_Utilities::get_posts_as_array( $this->input_attrs );
		}
	 ...
	 */
	class Business_Commerce_Note_Control extends WP_Customize_Control {
		public $type = 'business_commerce_description';
	 ...
	 */
	if ( ! function_exists( 'business_commerce_url_sanitization' ) ) {
		function business_commerce_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'business_commerce_switch_sanitization' ) ) {
		function business_commerce_switch_sanitization( $input ) {
			return $input;
			if ( true === $input ) {
				return 1;
			} else {
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'business_commerce_radio_sanitization' ) ) {
		function business_commerce_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'business_commerce_text_sanitization' ) ) {
		function business_commerce_text_sanitization( $input ) {
	 ...
	 */
	function business_commerce_sanitize_select( $input, $setting ) {
	 ...
	 */
	function business_commerce_sanitize_map_code( $input ) {
		// allow iframe.
