...
<div class="primary-category-search-wrapper">
	<a href="#" id="category-search-toggle" class="menu-search-toggle"><span class="screen-reader-text"><?php esc_html_e( 'Search Products...', 'business-commerce-lite' ); ?></span><i class="fas fa-search"></i><i class="far fa-times-circle"></i></a>
			...
			<?php 
				...
				<div class="advance-search-wrap">
					<select class="select_products" name="product_cat">
						<option value=""><?php esc_html_e( 'All Categories', 'business-commerce-lite' ); ?></option>
				...
				<div class="advance-search-form">
					<label>
						...
						<input type="search" class="search-field" placeholder="<?php esc_attr_e( 'Search Products...', 'business-commerce-lite' ); ?>" value="<?php the_search_query(); ?>" name="s" />
					</label>
